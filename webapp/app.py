...
def update_ques_gender_scatter_plot(continent_value, country_value, demographic_value, plot_toggle):
    return ques_gender_scatter_plot(continent_value, country_value, demographic_value, plot_toggle) 


@app.callback([Output(component_id='summary_table_women', component_property='data'),
...
def update_summtbl_women(question_value, continent_value, demographic_value):
    return data_table(gender='F', statement_id=question_value, continent_code=continent_value, by_demographic=demographic_value)

@app.callback([Output(component_id='summary_table_men', component_property='data'),
...
def update_summtbl_men(question_value, continent_value, demographic_value):
    return data_table(gender='M', statement_id=question_value, continent_code=continent_value, by_demographic=demographic_value)

@app.callback([Output(component_id='statementtext_plot', component_property='children'),
...
@app.callback(Output(component_id='continenttext', component_property='children'),
              [Input(component_id='continent-dd', component_property='value')])
